...
begin
  ...
  QryCltaClube.SQL.Add('SELECT clube.clb_condigo');
  ...
  case Ptipo of
     tpIniciando:
     begin
       QryCltaClube.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr(pValor + '%'));
     end;
     tpContendo:
     begin
       QryCltaClube.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr('%' + pValor + '%'));
     ...
     tpIgual:
     begin
       QryCltaClube.SQL.Add('EHERE ' + pCampoNome + ' = ' + QuotedStr(pValor));
     end;
  end;
  QryCltaClube.Open();
end;
...
begin
  ...
  case Ptipo of
     tpIniciando:
     begin
       QryCltaPais.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr(pValor + '%'));
     end;
     tpContendo:
     begin
       QryCltaPais.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr('%' + pValor + '%'));
     ...
     tpIgual:
     begin
       QryCltaPais.SQL.Add('EHERE ' + pCampoNome + ' = ' + QuotedStr(pValor));
     end;
  end;
  QryCltaPais.Open();
end;
...
begin
  ...
  case Ptipo of
     tpIniciando:
     begin
       QryCltaTatica.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr(pValor + '%'));
     end;
     tpContendo:
     begin
       QryCltaTatica.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr('%' + pValor + '%'));
     ...
     tpIgual:
     begin
       QryCltaTatica.SQL.Add('EHERE ' + pCampoNome + ' = ' + QuotedStr(pValor));
     end;
  end;
  QryCltaTatica.Open();
end;
...
begin
  ...
  case Ptipo of
     tpIniciando:
     begin
       QryCltaTecnico.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr(pValor + '%'));
     end;
     tpContendo:
     begin
       QryCltaTecnico.SQL.Add('EHERE ' + pCampoNome + ' LIKE ' + QuotedStr('%' + pValor + '%'));
     ...
     tpIgual:
     begin
       QryCltaTecnico.SQL.Add('EHERE ' + pCampoNome + ' = ' + QuotedStr(pValor));
     end;
  end;
  QryCltaTecnico.Open();
end;
