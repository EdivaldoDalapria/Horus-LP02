object DataModuleQuerys: TDataModuleQuerys
  ...
  object QryPaises: TFDQuery
    ...
    OnUpdateError = QryPaisesUpdateError
  ...
  object QryTaticas: TFDQuery
    AfterInsert = QryTaticasAfterInsert
    Connection = DataModuleConexao.FDConnection1
    SQL.Strings = (
  ...
  object QryTecnicos: TFDQuery
    AfterInsert = QryTecnicosAfterInsert
    Connection = DataModuleConexao.FDConnection1
    SQL.Strings = (
  ...
  object QryClubes: TFDQuery
    ...
    UpdateOptions.GeneratorName = 'SEQ_CLB_CODIGO'
    UpdateOptions.AutoIncFields = 'CLB_CODIGO'
    SQL.Strings = (
