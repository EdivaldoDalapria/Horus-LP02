...
uses
  ...
  Frm.ConsultaJogador in 'Frm.ConsultaJogador.pas' {FrmConsultaJogador},
  Frm.ConsultaTecnico in 'Frm.ConsultaTecnico.pas' {FrmConsultaTecnico},
  Frm.ConsultaClube in 'Frm.ConsultaClube.pas' {FrmConsultaClube},
  Frm.ConsultaTatica in 'Frm.ConsultaTatica.pas' {FrmConsultaTatica},
  Frm.ConsultaPais in 'Frm.ConsultaPais.pas' {FrmConsultaPais};
